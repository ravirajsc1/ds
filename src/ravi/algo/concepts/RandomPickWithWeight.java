...
/*
    weights = [2, 5, 3]
    prefixSum = [2, 7, 10]
    We are treating the full range [1, 10] like a line of lottery tickets, with more tickets for higher-weighted items:

    Index 0 → tickets 1-2

    Index 1 → tickets 3-7

    Index 2 → tickets 8-10
 */
